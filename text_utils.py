...
def draw_text_with_shadow(draw, text, position, font, fill, shadow_offset, shadow_opacity):
    ...
    shadow_color = (*shadow_fill[:-1], shadow_opacity)  # Keep the same RGB values, change the alpha value
